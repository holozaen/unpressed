  ...
  <LayoutSidebarRight>
    <section class="w-full p-6">
      ...
      <div class="sm:flex flex-row flex-row">
        <div v-if="user.image" class="mb-2 sm:mb-0 w-full sm:w-1/12 mr-4 pt-2 min-w-3">
          <img :src="user.image.publicUrl" :alt="user.image.originalFilename" class="rounded-full"/>
        </div>
      ...
      meta: [
        {
          hid: "description",
          name: "description",
          content: this.user ? this.shorten(this.stripTags(this.user.content), 320) : ''
        }
      ],
    }
  },
